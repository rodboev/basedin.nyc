...
def test_default_output_is_the_homepage_and_accepts_an_override(repo_root: Path, tmp_path: Path, monkeypatch: MonkeyPatch) -> None:
    outputs: list[Path] = []

    def capture_report(**kwargs: object) -> int:
        output = kwargs["out_file"]
