"""Generate the pr-stats homepage (../index.html) from cached GitHub PR data.
...
Options:
    ...
    --out-file PATH          Rendered page path (default: site-root index.html).
...
DEFAULT_OUTPUT_FILE = Path(__file__).resolve().parent.parent / "index.html"
